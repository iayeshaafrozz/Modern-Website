    ...
    <section id="menu" className="section-pad bg-[#e5eee4]">
      <div className="container-wide">
        <div className="flex flex-col justify-between gap-7 md:flex-row md:items-end">
          ...
          <div className="reveal delay-1 max-w-sm text-sm leading-6 text-[#426266]">From first bites to the last sip, find something worth staying for. <b className="text-[#163f42]">All prices are exclusive of taxes.</b></div>
        </div>
